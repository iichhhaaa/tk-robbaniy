    ...
    <div class="container">
        ...
        <div class="card o-hidden border-0 shadow-lg my-5">
            <div class="card-body p-0">
                ...
                <div class="row">
                    <img src="assets/login.jpg" class="col-lg-5 d-none d-lg-block bg-login-image" alt="Image description">
                    <div class="col-lg-7">
                        <div class="p-5">
                            <div class="text-center">
                                ...
                                <form method="POST" action="register-store.php" class="user">
                                    ...
                                    <div class="form-group">
                                        <input type="password" class="form-control form-control-user" id="confirm_password" placeholder="Confirm Password" name="confirm_password" required>
                                    </div>
