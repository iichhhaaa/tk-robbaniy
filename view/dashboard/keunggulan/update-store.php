...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $sql_fetch = "SELECT foto FROM keunggulan WHERE id = ?";
    ...
    if ($_FILES["foto"]["name"] != "") {
        ...
        $target_dir = "../../../storage/keunggulan/"; // Directory to store the uploaded image
    ...
    $sql_update = "UPDATE keunggulan SET judul = ?, deskripsi = ?, foto = ? WHERE id = ?";

    if ($stmt_update = $conn->prepare($sql_update)) {
        // Bind the parameters
        $stmt_update->bind_param("sssi", $judul, $deskripsi, $foto, $id);
